...
$msg="Booking Cancelled successfully!";
  ...
  $masg = "Dear Sir/Madam,
You have cancelled the booking. Please follow the cancellation policy.
...
<td><?php echo htmlentities($result->member);?></td>
...
{
 ?><td><button type="submit" name="submit9" class="btn-primary btn"><a href="payment.php" style="color: white">Payment</a></button></td>
 <?php } else {?>
    <td>Cancelled</td>
<?php }?>
